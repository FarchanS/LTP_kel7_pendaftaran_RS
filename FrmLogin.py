...
class Ui_FrmLogin(object):
    def setupUi(self, FrmLogin):
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(60, 70, 221, 81))
        ...
        self.Chk_show_pass = QtWidgets.QCheckBox(self.formLayoutWidget)
        self.Chk_show_pass.setObjectName("Chk_show_pass")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.Chk_show_pass)
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(60, 160, 221, 31))
        ...
        FrmLogin.setTabOrder(self.Txt_username, self.Txt_password)
        FrmLogin.setTabOrder(self.Txt_password, self.PB_login)
    ...
    def retranslateUi(self, FrmLogin):
        ...
        self.Chk_show_pass.setText(_translate("FrmLogin", "Show Password"))
